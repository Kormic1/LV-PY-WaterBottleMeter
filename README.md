...
3. Lokalnie utworzona baza danych (zalecany PostgreSQL jako SZDB (System Zarządzania Bazą Danych), po instalacji należy pamiętać o zainstalowaniu sterownika psqlODBC chociażby przy użyciu Stack Buildera).
